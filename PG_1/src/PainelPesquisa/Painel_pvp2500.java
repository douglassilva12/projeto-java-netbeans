...
public class Painel_pvp2500 extends javax.swing.JDialog {

    private int id = 0;
    String numero, nome, tipo1, tipo2;
    ControllerPvP2500StatusDB pvp2500DB = new ControllerPvP2500StatusDB();

    public Painel_pvp2500(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Painel_pvp2500.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Painel_pvp2500 dialog = new Painel_pvp2500(new javax.swing.JFrame(), true);
    ...
    private void listarTodosRegistros() {
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            ArrayList<ModelPvP2500Status> pvp2500 = pvp2500DB.getNumero(numeroPokemon);

            // Percorre a lista de produtos        
            for (ModelPvP2500Status auxPvp : pvp2500) {
            ...
            // Lista todos registros da tabela
            ArrayList<ModelPvP2500Status> pvp2500 = pvp2500DB.getTodos();
