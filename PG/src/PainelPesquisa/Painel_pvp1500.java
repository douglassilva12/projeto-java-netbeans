...
public class Painel_pvp1500 extends javax.swing.JDialog {

    private int id = 0;
    String numero, nome, tipo1, tipo2;
    ControllerPvP1500StatusDB pvp1500DB = new ControllerPvP1500StatusDB();

    public Painel_pvp1500(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Painel_pvp1500.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Painel_pvp1500 dialog = new Painel_pvp1500(new javax.swing.JFrame(), true);
    ...
    private void listarTodosRegistros() {
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            ArrayList<ModelPvP1500Status> pvp1500 = pvp1500DB.getNumero(numeroPokemon);

            // Percorre a lista de produtos        
            for (ModelPvP1500Status auxPvp : pvp1500) {
            ...
            // Lista todos registros da tabela
            ArrayList<ModelPvP1500Status> pvp1500 = pvp1500DB.getTodos();
