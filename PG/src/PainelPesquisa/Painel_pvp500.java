...
public class Painel_pvp500 extends javax.swing.JDialog {

    private int id = 0;
    String numero, nome, tipo1, tipo2;
    ControllerPvP500StatusDB pvp500DB = new ControllerPvP500StatusDB();

    public Painel_pvp500(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Painel_pvp500.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Painel_pvp500 dialog = new Painel_pvp500(new javax.swing.JFrame(), true);
    ...
    private void listarTodosRegistros() {
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            ArrayList<ModelPvP500Status> pvp500 = pvp500DB.getNumero(numeroPokemon);

            // Percorre a lista de produtos        
            for (ModelPvP500Status auxPvp : pvp500) {
            ...
            // Lista todos registros da tabela
            ArrayList<ModelPvP500Status> pvp500 = pvp500DB.getTodos();
